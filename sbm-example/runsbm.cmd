...
cd ..
@echo on
python -m pyqd --x0=@%fprefix%-x.txt --k0=@%fprefix%-p.txt --args=%fprefix%-model.txt --nstep=%nstep%0000 --dt=%timestep% --dstep=100 --model=sbm --m=1 --task=ehrenfest --obj=population --box=-10000,10000 --batch=0